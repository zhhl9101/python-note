...
此时decorator方法中断，执行decorator1，输出"权限认证111"，执行到func1(*args, **kwargs)的时候，即执行play(*args, **kwargs)，
此时decorator1方法中断，执行play，输出"被装饰的方法()"，play执行完毕后，返回方法decorator1，输出"权限认证222"，
decorator1执行完毕后，返回方法decorator，输出"log系统222"。
```
